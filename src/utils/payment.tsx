...
export default function generatePixQrCode(pixKey: string, amount: number, merchantName: string, merchantCity: string) {
  ...
  const transactionAmount = amount ? `54${('00' + amount).slice(-2)}${amount}` : '';
